...
public class view : MonoBehaviour
{
    ...
    {
        if (Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.DownArrow))//(Input.GetAxis("Horizontal")<0)
        {
            transform.Translate(new Vector3(-keyBoardMoveSpeed, 0, 0), Space.World);
        }
        ...
        {
            transform.Translate(new Vector3(0, 0, keyBoardMoveSpeed), Space.World);
        }
